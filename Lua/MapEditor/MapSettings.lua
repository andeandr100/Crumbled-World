...
function create()
	...
	if camera then
		--Set default values
		setDeafultValue("difficultyNormalMin", 1.0)
		setDeafultValue("difficultyNormalMax", 2.0)
		setDeafultValue("difficultyHardMin", 1.0)
		setDeafultValue("difficultyHardMax", 2.0)
		...
		local informationPanel = mainArea:add(Panel(PanelSize(Vec2(-1,0.17))))
		local namePanel = informationPanel:add(Panel(PanelSize(Vec2(-0.40,-1))))

		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Name:", MainMenuStyle.textColor))
		...
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Difficulty Easy:", MainMenuStyle.textColor))
		difficultyFieldNormalMin = namePanel:add(TextField(PanelSize(Vec2(-0.44,0.025)), tostring(MapSettings.difficultyMin)))
		difficultyFieldNormalMin:setWhiteList(directionChars)
		difficultyFieldNormalMin:addEventCallbackChanged(saveMapSettings)
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(0.21,1)), "/", MainMenuStyle.textColor))
		difficultyFieldNormalMax = namePanel:add(TextField(PanelSize(Vec2(-1,0.025)), tostring(MapSettings.difficultyMax)))
		difficultyFieldNormalMax:setWhiteList(directionChars)
		difficultyFieldNormalMax:addEventCallbackChanged(saveMapSettings)
		
		
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Difficulty Hard:", MainMenuStyle.textColor))
		difficultyFieldHardMin = namePanel:add(TextField(PanelSize(Vec2(-0.44,0.025)), tostring(MapSettings.difficultyMin)))
		difficultyFieldHardMin:setWhiteList(directionChars)
		difficultyFieldHardMin:addEventCallbackChanged(saveMapSettings)
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(0.21,1)), "/", MainMenuStyle.textColor))
		difficultyFieldHardMax = namePanel:add(TextField(PanelSize(Vec2(-1,0.025)), tostring(MapSettings.difficultyMax)))
		difficultyFieldHardMax:setWhiteList(directionChars)
		difficultyFieldHardMax:addEventCallbackChanged(saveMapSettings)
		
		
		
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Wave count:", MainMenuStyle.textColor))
		...
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Type:", MainMenuStyle.textColor))
		...
		namePanel:add(Label(PanelSize(Vec2(-1,0.025), Vec2(4.5,1)), "Players:", MainMenuStyle.textColor))
...
function reloadData()
	...
	difficultyFieldNormalMin:setText(tostring(MapSettings.difficultyNormalMin))
	difficultyFieldNormalMax:setText(tostring(MapSettings.difficultyNormalMax))
	difficultyFieldHardMin:setText(tostring(MapSettings.difficultyHardMin))
	difficultyFieldHardMax:setText(tostring(MapSettings.difficultyHardMax))
