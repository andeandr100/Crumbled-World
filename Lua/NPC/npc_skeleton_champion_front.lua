...
function create()
	...
	npcBase.init("skeleton_champion_front","npc_skeleton_champion_front.mym",0.45,0.6,1.3,2.0)
	npcBase.getSoul().enableBlood("BoneSplatterSphere",1.0,Vec3(0,0.35,0))
	--shield blocking
	npcBase.getSoul().setShieldAngle(math.pi*(1/3),true)--120deg block. (+-60deg), front==true
