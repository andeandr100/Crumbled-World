...
function MapListPanel.new(panel, changeMapCallback)
	...
	local function init()
		...
		labels[1] = headerPanel:add(Label(PanelSize(Vec2(-0.65, -1)), language:getText("general.name"), Vec4(0.95)))
		labels[2] = headerPanel:add(Label(PanelSize(Vec2(-0.5, -1)), language:getText("general.size"), Vec3(0.95)))
		labels[3] = headerPanel:add(Label(PanelSize(Vec2(-1, -1)), language:getText("multiplayer.players"), Vec3(0.95)))
		
		labels[1]:setTag("general.name")
		labels[2]:setTag("general.size")
		labels[3]:setTag("multiplayer.players")
