...
--		namePanel:add(Panel(PanelSize(Vec2(-0.1, -1))))
		namePanel:add(Label(PanelSize(Vec2(-1.0)), language:getText("info-screen.name"), Vec4(0.95)))
		--
		local killsPanel = headerPanel:add(Panel(PanelSize(Vec2(weight[2], -1))))
		...
		icon:setToolTip(language:getText("info-screen.Kills"))
		--
		local totalDamagePanel = headerPanel:add(Panel(PanelSize(Vec2(weight[3], -1))))
		...
		icon:setToolTip(language:getText("info-screen.Total damage"))
		--
		local damagePanel = headerPanel:add(Panel(PanelSize(Vec2(weight[4], -1))))
		...
		icon:setToolTip(language:getText("info-screen.average damage"))
		--
		local goldPanel = headerPanel:add(Panel(PanelSize(Vec2(weight[5], -1))))
		local icon = goldPanel:add(Image(PanelSize(Vec2(-1), Vec2(1)), Text("icon_table.tga") ))
		icon:setUvCoord(Vec2(0,0),Vec2(0.125,0.0625))
		icon:setToolTip(language:getText("info-screen.available gold"))
		--
		local goldTotalPanel = headerPanel:add(Panel(PanelSize(Vec2(weight[6], -1))))
		...
		icon:setToolTip(language:getText("info-screen.all earned gold"))
		--
		...
		icon:setToolTip(language:getText("info-screen.active speed modifier"))
		--
		local pingPanel = headerPanel:add(Panel(PanelSize(Vec2(weight[8], -1))))
		...
		icon:setToolTip(language:getText("info-screen.ping"))
		--
		--
		--
		...
		for clientId,tab in pairs(players) do
			...
			labels.kills =		line:add(Label(PanelSize(Vec2(weight[2], -1)), "0", Vec3(0.95)))
			labels.totalDamage =line:add(Label(PanelSize(Vec2(weight[3], -1)), "0%", Vec3(0.95)))
			labels.damage = 	line:add(Label(PanelSize(Vec2(weight[4], -1)), "0%", Vec3(0.95)))
			labels.gold = 		line:add(Label(PanelSize(Vec2(weight[5], -1)), tostring(tab.gold), Vec3(0.95)))
			labels.goldTotal = 	line:add(Label(PanelSize(Vec2(weight[6], -1)), tostring(tab.goldTotal), Vec3(0.95)))
			labels.speed = 		line:add(Label(PanelSize(Vec2(weight[7], -1)), tostring(tab.speed), Vec3(0.95)))
			labels.ping = 		line:add(Label(PanelSize(Vec2(weight[8], -1)), tostring(tab.ping), Vec3(0.95)))
		end
	end
	init()
