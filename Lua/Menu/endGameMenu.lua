	...
	if isNextCampaignMapAvailable() then
		...
		if mapFile:isFile() then
			...
			if mapInformation then
				...
				mapInfo.setDifficultyNormalMin(mapInformation.difficultyNormalMin)
				mapInfo.setDifficultyNormalMax(mapInformation.difficultyNormalMax)
				mapInfo.setDifficultyHardMin(mapInformation.difficultyHardMin)
				mapInfo.setDifficultyHardMax(mapInformation.difficultyHardMax)
