...
function CampaignData.new()
	...
	local files = { 
		{file=File("Data/Map/Campaign/Beginning.map"), 		statId="Begining",		statIdOld="L1",		minScore=14000,	type="Crystal",	sead=258187458,	waveCount=10},--9000+5000 = 14000
		{file=File("Data/Map/Campaign/Intrusion.map"), 		statId="Intrusion",		statIdOld="L2",		minScore=00000,	type="Crystal",	sead=334652485,	waveCount=15},
		{file=File("Data/Map/Campaign/Stockpile.map"),		statId="Stockpile",		statIdOld="L3",		minScore=00000,	type="Crystal",	sead=294158370,	waveCount=20},
		{file=File("Data/Map/Campaign/Expansion.map"), 		statId="Expansion",		statIdOld="L4",		minScore=00000,	type="Crystal",	sead=864885368,	waveCount=25},
		{file=File("Data/Map/Campaign/Repair station.map"),	statId="RepairStation",	statIdOld="L5",		minScore=00000,	type="Cart",	sead=256546887,	waveCount=20},
		{file=File("Data/Map/Campaign/Edge world.map"),		statId="EdgeWorld",							minScore=00000,	type="Cart",	sead=352603864,	waveCount=25},
		{file=File("Data/Map/Campaign/Bridges.map"),		statId="Bridges",		statIdOld="L6",		minScore=00000,	type="Crystal",	sead=617196048,	waveCount=20},
		{file=File("Data/Map/Campaign/Spiral.map"),			statId="Spiral",		statIdOld="L7",		minScore=00000,	type="Crystal",	sead=109723780,	waveCount=25},
		{file=File("Data/Map/Campaign/Broken mine.map"),	statId="BrokenMine",						minScore=00000,	type="Cart",	sead=104266217,	waveCount=25},
		{file=File("Data/Map/Campaign/Town.map"),			statId="Town",			statIdOld="L8",		minScore=00000,	type="Crystal",	sead=956148502,	waveCount=25},
		{file=File("Data/Map/Campaign/Plaza.map"),			statId="Plaza",			statIdOld="L9",		minScore=00000,	type="Crystal",	sead=169366078,	waveCount=20},
		{file=File("Data/Map/Campaign/Long haul.map"),		statId="LongHaul",		statIdOld="L10",	minScore=00000,	type="Cart",	sead=202469227,	waveCount=20},
		{file=File("Data/Map/Campaign/Dock.map"),			statId="Dock",			statIdOld="L11",	minScore=00000,	type="Crystal",	sead=742525885,	waveCount=25},
		{file=File("Data/Map/Campaign/Lodge.map"),			statId="Lodge",								minScore=00000,	type="Crystal",	sead=418531867,	waveCount=25},
		{file=File("Data/Map/Campaign/Crossroad.map"),		statId="Crossroad",		statIdOld="L12",	minScore=00000,	type="Crystal",	sead=365654225,	waveCount=25},
		{file=File("Data/Map/Campaign/Mine.map"),			statId="Mine",			statIdOld="L13",	minScore=00000,	type="Cart",	sead=464004721,	waveCount=20},
		{file=File("Data/Map/Campaign/West river.map"),		statId="West river",						minScore=00000,	type="Crystal",	sead=242072855,	waveCount=25},
		{file=File("Data/Map/Campaign/Blocked path.map"),	statId="BlockedPath",	statIdOld="L14",	minScore=00000,	type="Crystal",	sead=32111861,	waveCount=20},
		{file=File("Data/Map/Campaign/The line.map"),		statId="TheLine",		statIdOld="L15",	minScore=00000,	type="Cart",	sead=752499248,	waveCount=20},
		{file=File("Data/Map/Campaign/Dump station.map"),	statId="DumpStation",						minScore=00000,	type="Crystal",	sead=32111861,	waveCount=25},
		{file=File("Data/Map/Campaign/Rifted.map"),			statId="Rifted",		statIdOld="L16",	minScore=00000,	type="Crystal",	sead=27518540,	waveCount=25},
		{file=File("Data/Map/Campaign/Paths.map"), 			statId="Paths",			statIdOld="L17",	minScore=00000,	type="Crystal",	sead=620382518,	waveCount=25},
		{file=File("Data/Map/Campaign/Divided.map"),		statId="Divided",		statIdOld="L18",	minScore=00000,	type="Crystal",	sead=615837167,	waveCount=25},
		{file=File("Data/Map/Campaign/Nature.map"),			statId="Nature",		statIdOld="L19",	minScore=00000,	type="Crystal",	sead=581083960,	waveCount=25},
		{file=File("Data/Map/Campaign/Train station.map"),	statId="TrainStation",	statIdOld="L20",	minScore=00000,	type="Cart",	sead=680821396,	waveCount=25},
		{file=File("Data/Map/Campaign/Desperado.map"),		statId="Desperado",							minScore=00000,	type="Crystal",	sead=842172835,	waveCount=30},
		{file=File("Data/Map/Campaign/The end.map"),		statId="TheEnd",		statIdOld="L21",	minScore=00000,	type="Crystal",	sead=394914309,	waveCount=30} 
	}
