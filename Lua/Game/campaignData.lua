...
function CampaignData.new()
	...
	local files = { 
		...
		{file=File("Data/Map/Campaign/Bridges.map"),		statId="Bridges",		statIdOld="L6",		minScore=15000,	maxScore=34000,	type="Crystal",	sead=617196048,	waveCount=25},--? / 32474								--33k
		{file=File("Data/Map/Campaign/Spiral.map"),			statId="Spiral",		statIdOld="L7",		minScore=15000,	maxScore=34000,	type="Crystal",	sead=109723780,	waveCount=25},--? / 30000								--31k
		...
		{file=File("Data/Map/Campaign/Town.map"),			statId="Town",			statIdOld="L8",		minScore=15000,	maxScore=34000,	type="Crystal",	sead=956148502,	waveCount=25},--? / 32000(2.65)[10K]					--30k	
		{file=File("Data/Map/Campaign/Centeral.map"),		statId="Centeral",							minScore=15000,	maxScore=30000,	type="Crystal",	sead=187549817,	waveCount=25},--? /
		...
		{file=File("Data/Map/Campaign/Plaza.map"),			statId="Plaza",			statIdOld="L9",		minScore=15000,	maxScore=35000,	type="Crystal",	sead=169366078,	waveCount=25},--? / 35000(2.5)							--
		{file=File("Data/Map/Campaign/Long haul.map"),		statId="LongHaul",		statIdOld="L10",	minScore=15000,	maxScore=28000,	type="Cart",	sead=202469227,	waveCount=25},--? / 27695(2)[22k]						--
		{file=File("Data/Map/Campaign/Dock.map"),			statId="Dock",			statIdOld="L11",	minScore=15000,	maxScore=28000,	type="Crystal",	sead=742525885,	waveCount=25},--? / 26503								--
		...
		{file=File("Data/Map/Campaign/Crossroad.map"),		statId="Crossroad",		statIdOld="L12",	minScore=15000,	maxScore=30000,	type="Crystal",	sead=365654225,	waveCount=25},--? / 27472								--27k
		{file=File("Data/Map/Campaign/Mine.map"),			statId="Mine",			statIdOld="L13",	minScore=15000,	maxScore=38000,	type="Cart",	sead=464004721,	waveCount=25},--? / 37000[15k]					--
		...
		{file=File("Data/Map/Campaign/Blocked path.map"),	statId="BlockedPath",	statIdOld="L14",	minScore=15000,	maxScore=50000,	type="Crystal",	sead=32111861,	waveCount=25},--? / 50000				--
		{file=File("Data/Map/Campaign/The line.map"),		statId="TheLine",		statIdOld="L15",	minScore=15000,	maxScore=30000,	type="Cart",	sead=752499248,	waveCount=25},--? / 29111[4k]							--
		...
		{file=File("Data/Map/Campaign/Rifted.map"),			statId="Rifted",		statIdOld="L16",	minScore=15000,	maxScore=28000,	type="Crystal",	sead=27518540,	waveCount=25},--? / 22583[5k]							--
		{file=File("Data/Map/Campaign/Paths.map"), 			statId="Paths",			statIdOld="L17",	minScore=15000,	maxScore=38000,	type="Crystal",	sead=620382518,	waveCount=25},--? / 37000[15]				--
		{file=File("Data/Map/Campaign/Divided.map"),		statId="Divided",		statIdOld="L18",	minScore=15000,	maxScore=35000,	type="Crystal",	sead=615837167,	waveCount=25},--? / 33000(5.5) ?(6.25)					--
		{file=File("Data/Map/Campaign/Nature.map"),			statId="Nature",		statIdOld="L19",	minScore=15000,	maxScore=35000,	type="Crystal",	sead=581083960,	waveCount=25},--? / 33000(3.5)[11k] ?(3.75)				--
		{file=File("Data/Map/Campaign/Train station.map"),	statId="TrainStation",	statIdOld="L20",	minScore=15000,	maxScore=25000,	type="Cart",	sead=680821396,	waveCount=25},--? / 24105 (4k)							--25k
		...
		{file=File("Data/Map/Campaign/The end.map"),		statId="TheEnd",		statIdOld="L21",	minScore=15000,	maxScore=40000,	type="Crystal",	sead=394914309,	waveCount=30} --? / 39000 (13k)
	}
